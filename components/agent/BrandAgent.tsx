    ...
    <div className="flex flex-col h-full">
      {isEmpty ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6">
          ...
          {/* FLOW ANIMATION PLACEHOLDER — replace with Lottie animation component when ready */}
          <svg
            viewBox="0 0 1835 900"
            fill="none"
            ...
            aria-hidden="true"
          >
            <path d="M1766.63 647.398C1811.98 571.32 1834.66 493.047 1834.66 412.579L1599.84 471.832C1599.84 540.596 1585.94 599.117 1558.14 647.398C1531.81 695.678 1490.11 719.819 1433.05 719.819C1368.68 719.819 1305.77 691.289 1244.32 634.23C1182.87 575.709 1035.84 397.217 1035.84 397.217L950.248 294.072C950.248 294.072 801.018 128.017 726.402 76.8099C651.787 25.6033 567.662 0 474.027 0C396.486 0 321.139 23.4087 247.986 70.2262C174.834 117.044 114.849 178.492 68.0316 254.57C22.6772 329.185 0 405.995 0 485L234.819 427.941C234.819 363.567 250.912 307.24 283.099 258.959C315.286 209.216 359.909 184.344 416.968 184.344C476.953 184.344 533.28 209.216 585.95 258.959C640.083 307.24 702.262 376.003 772.488 465.249L801.018 502.556L884.411 603.507C959.027 695.678 1033.64 768.099 1108.26 820.769C1184.34 873.438 1269.19 899.773 1362.83 899.773C1440.37 899.773 1515.72 876.365 1588.87 829.547C1662.02 782.73 1721.27 722.013 1766.63 647.398Z" fill="#5F8A96"/>
            <path d="M1630.56 57.0588C1564.73 19.0196 1486.45 0 1395.75 0C1316.74 0 1241.39 26.3348 1169.71 79.0045C1099.48 131.674 1026.33 203.363 950.248 294.072L801.018 502.556C695.678 651.787 598.386 726.402 509.14 726.402C460.86 726.402 415.505 712.503 373.077 684.706C332.111 655.445 298.461 618.137 272.127 572.783C247.255 525.965 234.819 477.685 234.819 427.941L0 485C0 559.615 18.2881 628.378 54.8642 691.289C92.9034 754.2 145.573 804.675 212.873 842.715C281.636 880.754 361.372 899.773 452.081 899.773C531.086 899.773 604.238 874.17 671.538 822.963C740.301 770.294 811.259 697.141 884.411 603.507L1035.84 397.217C1148.49 252.375 1250.17 179.955 1340.88 179.955C1387.7 179.955 1430.86 193.854 1470.36 221.651C1511.33 249.449 1542.78 286.025 1564.73 331.38C1588.14 376.734 1599.84 423.552 1599.84 471.832L1834.66 412.579C1834.66 337.964 1817.1 269.201 1781.99 206.29C1748.34 143.379 1697.86 93.6349 1630.56 57.0588Z" fill="#5F8A96"/>
          </svg>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
              {messages.map((msg, i) => (
                ...
                >
                  {msg.role === "assistant" && (
                    <div className="shrink-0 mt-0.5 w-7 h-7 flex items-center justify-center">
                      <AgentAnimation state={i === messages.length - 1 ? animState : "idle"} />
                    </div>
                  )}
                  <div
