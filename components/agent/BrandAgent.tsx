    ...
    <div className="flex flex-col h-full">
      {isEmpty ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6">
          ...
          {/* FLOW ANIMATION PLACEHOLDER — replace this SVG with the Lottie animation component when ready */}
          <svg
            viewBox="0 0 120 60"
            fill="none"
          ...
          >
            <path
              d="M 60,30 C 60,14 73,2 90,2 C 107,2 120,14 120,30 C 120,46 107,58 90,58 C 73,58 60,46 60,30 C 60,14 47,2 30,2 C 13,2 0,14 0,30 C 0,46 13,58 30,58 C 47,58 60,46 60,30 Z"
              stroke="#212121"
              strokeOpacity="0.2"
              strokeWidth="2"
              strokeLinecap="round"
